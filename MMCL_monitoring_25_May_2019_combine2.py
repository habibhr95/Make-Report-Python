...
class Open_gui:
    ...
    def menu_bars(cls):
        ...
        noc_name = Menu(menubar)
        noc_name.add_radiobutton(label="Habib", command=partial(mail_instance.__init__, "Md. Habibur Rahman"))
        noc_name.add_radiobutton(label="Turzo", command=partial(mail_instance.__init__, "Turzo"))
        noc_name.add_radiobutton(label="Turaz", command=partial(mail_instance.__init__, "Turaz"))
        noc_name.add_radiobutton(label="Amit", command=partial(mail_instance.__init__, "Amit Roy"))
        noc_name.add_radiobutton(label="Tusher", command=partial(mail_instance.__init__, "Tusher"))
        noc_name.add_radiobutton(label="Obeydulla", command=partial(mail_instance.__init__, "Oboydulla"))
...
class Mail:
    def __init__(self,name="Md. Habibu"):
        self.name = name
        print(self.name)
    ...
    def kpi(self):
        print("start kpi mail ",self.name)
        to="raj@mmclbd"
        ...
        r'<style> body { font-family: Times New Roman;font-size: 14.5px;} </style>'  \
        '</head>'   \
        "<body>" \
        'Dear Vaiya, <br>'  \
        f'Please check the domestic kpi report on June 2019 {upto}.'    \
        '<br><br>'  \
        '<b>Regards</b>  <br>'  \
        f'{name}<br>'  \
        ...
        # body = obj_body.read()
        hh = r'<br><br>Regards<br> HR {to} <br><img src="C:\Users\Habib\PycharmProjects\June2019\report\logo.jpg"> <br>01777722222             <br> noc@mmclbd.com          <br></body></html>'
        body = f"{h}"
