...
pip install python-resize-image  # For resize images not using
'''
    ...
    def csv_file(self):
        ...
        for itm in range(length_fd1): #this loop work at the end of the line  of csv file
            ...
            if itm == 0:
                ...
                print('habib------',row_list,len(row_list))
        ...
        for color1 in ccr.iter_rows(min_row=3, min_col=1):  # red mark ccr less than 80%
            if int(color1[ccr.max_column - 5].value) < 80:
...
if __name__ == "__main__":
    ...
    Button(frm_check_b,text="Select Countries",command=ins_text.country_selection,font=font,height=1, fg=fg_1,bg=bg_21).grid(row=0,column=1)
