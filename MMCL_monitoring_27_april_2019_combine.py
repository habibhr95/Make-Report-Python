...
class idd_class:
    ...
    def csv_file(self):
        ...
        try:
            ...
            #cell_range = f"a1:{col_letter}{max_row}"
            self.set_border(ws_idd,cell_range)
            top_cell_range = [1,2,1,ws_idd.max_column]  # set style top row
            self.set_border(ws_idd,top_cell_range,bd_sty="medium",font_weight=True,bg_color="bb0000")  # Border width = medium valid !!
            top_cell_range = [2,ws_idd.max_column-2,ws_idd.max_row,ws_idd.max_column]  # set style ASR,ACD,CCR
            self.set_border(ws_idd,top_cell_range,bd_sty="thin",font_weight=True,bg_color="00aa04")
            ...
            wb_idd.save(f"IDD Report {date_file[2]} {month_file} {date_file[0]} (Every 2 Hours).xlsx");
...
class ccr_class:
    ...
    def csv_file(self):
        ...
        try:
            ...
            # set border and cell property to all cells
            instance_of_idd.set_border(ccr,[1,1,1,ccr.max_column],bd_sty="medium",font_weight=False,bg_color="009900")
...
class upload:
    ...
    def __init__(self):
        ...
        self.total_time = 0
        self.header_color = "bb0000"
        self.side_color = "00bb00"
    ...
    def upload_idd(self):
        ...
        if self.filename != '':
            ...
            raw_idd.uploaded_cvs_to_xlsx_kpi()
        return self.filename
    ...
    def city_report(self,city,list_kpi_trunk_city,ws_raw_data,dic_trunk_col_raw,time_range):
        ...
        self.set_border(City, cell_range=cell_range_h,bd_sty="medium",font_weight=True,bg_color=self.header_color)
        ...
        for itm, item in zip(list_kpi_trunk_city,range(length)):  # for all trunk in a city.
            ...
            self.set_border(City,cell_range=cell_range_cal,bd_sty="medium",bg_color=self.side_color,wraptext=False)
    ...
    def summary(self, all_dic):
        ...
        list_bd_sty_H = [cell_range_dhH,cell_range_chH,cell_range_khH,cell_range_suH]
        list_bd_sty = [cell_range_dh1,cell_range_ch1,cell_range_kh1,cell_range_su1]
        ...
        for bd_sty_r in list_bd_sty_H: self.set_border(ws_summary,cell_range=bd_sty_r,bd_sty=bd_sty,bg_color=self.header_color,font_weight=font_weight,font_size=14)
    ...
    def summary_ios(self,all_dic):
        ...
        for itm in range(2): self.set_border(ws_summary,cell_range[itm],bd_sty="medium",font_weight=True,bg_color=self.header_color,font_size=14)
    ...
    def make_IDD_report(self):
        kip_conform.set(f"No function found")
...
frm.grid(row=0,column = 0)      # this is the main frame for ccr idd
...
btn_3 = Button(raw_frame,command=raw_idd.fileupload,textvariable=raw_idd_file_path,width=width_1,font="Times 15", bg=bg_kpi1, anchor="w");
...
frm_kpi.grid(row=2,column = 0)      # this is the main frame for KPI report, inside top
